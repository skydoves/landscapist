...
private val viewerImageUrls = listOf(
...
@Composable
fun ImageViewerProfiles() {
  ImageViewer(
    images = viewerImageUrls,
    modifier = Modifier.height(360.dp),
    state = rememberImageViewerState(pageCount = { viewerImageUrls.size }),
    component = LocalImageComponent.current,
    imageOptions = ImageOptions(tag = "ImageViewer"),
  )
}
