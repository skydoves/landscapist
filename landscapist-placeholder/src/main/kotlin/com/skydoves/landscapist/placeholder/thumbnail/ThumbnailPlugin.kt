...
/**
 * A pluggable thumbnail executor that will be rendered depending on the image states is [ImageLoadState.Loading].
 */
public class ThumbnailPlugin(
  private val requestSize: IntSize = IntSize(15, 15),
